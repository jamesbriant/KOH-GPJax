...
class KOHPosterior(AbstractPosterior[PKOH, GL]):
    ...
    def predict_eta(
        ...
        # # Observation noise o²
        # # obs_var = self.likelihood.obs_stddev.value**2 # No longer used as already implemented into kernel
        # mx = self.prior.mean_function(x)
    ...
    def predict_zeta(
        ...
        #     Ktt += jnp.identity(Ktt.shape[0]) * obs_var
        # Ktt = PSD(Dense(Ktt))
