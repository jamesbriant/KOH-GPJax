...
DATAFIELD = np.loadtxt("/Users/jamesbriant/Documents/Projects/BayesianCalibrationExamples/presentable/data/toy/field.csv", delimiter=",", dtype=np.float32)
DATACOMP = np.loadtxt("/Users/jamesbriant/Documents/Projects/BayesianCalibrationExamples/presentable/data/toy/sim.csv", delimiter=",", dtype=np.float32)
